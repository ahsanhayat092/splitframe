    ...
    <section ref={ref} className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="relative mx-auto flex w-full max-w-[1200px] flex-col items-center px-6 text-center">
        <motion.h2
          ...
          className="font-display text-3xl font-semibold leading-[1.1] tracking-[-0.02em] text-ink md:text-4xl"
        >
          Ready when your footage is.
        </motion.h2>

        <motion.div style={{ y: ctaY, opacity: ctaOpacity }} className="mt-10">
          <Link
            to="/editor"
